            ...
            child: Column(
              children: <Widget>[
                ...
                TextField(
                  ...
                  decoration: InputDecoration(hintText: 'Nomor Meja', labelText: 'Nomor Meja'),
                ),
                TextField(
                  controller: _pembelianPenawaranController,
                  decoration: InputDecoration(hintText: 'Jumlah dan Satuan', labelText: 'Jumlah dan Satuan'),
                )
              ],
            ),
          ),
